...
export function PatchIdentitiesBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): PatchIdentitiesBody {
    ...
    return {
        ...
        'identities': !exists(json, 'identities') ? undefined : ((json['identities'] as Array<any>).map(IdentityPatchFromJSON)),
    };
}
...
export function PatchIdentitiesBodyToJSON(value?: PatchIdentitiesBody | null): any {
    ...
    return {
        ...
        'identities': value.identities === undefined ? undefined : ((value.identities as Array<any>).map(IdentityPatchToJSON)),
    };
}
