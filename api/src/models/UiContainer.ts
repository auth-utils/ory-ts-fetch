...
export function UiContainerFromJSONTyped(json: any, ignoreDiscriminator: boolean): UiContainer {
    ...
    return {
        ...
        'action': json['action'],
        'messages': !exists(json, 'messages') ? undefined : ((json['messages'] as Array<any>).map(UiTextFromJSON)),
        'method': json['method'],
...
export function UiContainerToJSON(value?: UiContainer | null): any {
    ...
    return {
        ...
        'action': value.action,
        'messages': value.messages === undefined ? undefined : ((value.messages as Array<any>).map(UiTextToJSON)),
        'method': value.method,
