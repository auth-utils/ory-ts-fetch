...
export function instanceOfMessage(value: object): boolean {
    ...
    isInstance = isInstance && "send_count" in value;
    isInstance = isInstance && "status" in value;
    isInstance = isInstance && "subject" in value;
    isInstance = isInstance && "template_type" in value;
...
export function MessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): Message {
    ...
    return {
        ...
        'dispatches': !exists(json, 'dispatches') ? undefined : ((json['dispatches'] as Array<any>).map(MessageDispatchFromJSON)),
        'id': json['id'],
...
export function MessageToJSON(value?: Message | null): any {
    ...
    return {
        ...
        'dispatches': value.dispatches === undefined ? undefined : ((value.dispatches as Array<any>).map(MessageDispatchToJSON)),
        'id': value.id,
