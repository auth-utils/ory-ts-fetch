 ...
 */
export function instanceOfProjectBranding(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "created_at" in value;
    isInstance = isInstance && "default_theme" in value;
    isInstance = isInstance && "id" in value;
    isInstance = isInstance && "project_id" in value;
    isInstance = isInstance && "themes" in value;
...
export function ProjectBrandingToJSON(value?: ProjectBranding | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
