...
export function ExpandedPermissionTreeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExpandedPermissionTree {
    ...
    return {
        ...
        'children': !exists(json, 'children') ? undefined : ((json['children'] as Array<any>).map(ExpandedPermissionTreeFromJSON)),
        'tuple': !exists(json, 'tuple') ? undefined : RelationshipFromJSON(json['tuple']),
        'type': json['type'],
    };
}
...
export function ExpandedPermissionTreeToJSON(value?: ExpandedPermissionTree | null): any {
    ...
    return {
        ...
        'children': value.children === undefined ? undefined : ((value.children as Array<any>).map(ExpandedPermissionTreeToJSON)),
