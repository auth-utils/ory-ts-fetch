...
export function RelationshipsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Relationships {
    ...
    return {
        ...
        'relation_tuples': !exists(json, 'relation_tuples') ? undefined : ((json['relation_tuples'] as Array<any>).map(RelationshipFromJSON)),
    };
}
...
export function RelationshipsToJSON(value?: Relationships | null): any {
    ...
    return {
        ...
        'relation_tuples': value.relation_tuples === undefined ? undefined : ((value.relation_tuples as Array<any>).map(RelationshipToJSON)),
    };
}
