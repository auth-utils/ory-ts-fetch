...
export class OidcApi extends runtime.BaseAPI {
    ...
    async createOidcDynamicClientRaw(requestParameters: CreateOidcDynamicClientRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OAuth2Client>> {
        if (requestParameters.oAuth2Client === null || requestParameters.oAuth2Client === undefined) {
            throw new runtime.RequiredError('oAuth2Client','Required parameter requestParameters.oAuth2Client was null or undefined when calling createOidcDynamicClient.');
        }
    ...
    async deleteOidcDynamicClientRaw(requestParameters: DeleteOidcDynamicClientRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling deleteOidcDynamicClient.');
        }
    ...
    async getOidcDynamicClientRaw(requestParameters: GetOidcDynamicClientRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OAuth2Client>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling getOidcDynamicClient.');
        }
    ...
    async setOidcDynamicClientRaw(requestParameters: SetOidcDynamicClientRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OAuth2Client>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling setOidcDynamicClient.');
        }

        if (requestParameters.oAuth2Client === null || requestParameters.oAuth2Client === undefined) {
            throw new runtime.RequiredError('oAuth2Client','Required parameter requestParameters.oAuth2Client was null or undefined when calling setOidcDynamicClient.');
        }
