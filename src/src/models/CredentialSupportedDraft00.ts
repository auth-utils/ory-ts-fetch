 ...
 */
export function instanceOfCredentialSupportedDraft00(value: object): boolean {
    let isInstance = true;
...
export function CredentialSupportedDraft00FromJSONTyped(json: any, ignoreDiscriminator: boolean): CredentialSupportedDraft00 {
    ...
    return {
        ...
        'cryptographic_binding_methods_supported': !exists(json, 'cryptographic_binding_methods_supported') ? undefined : json['cryptographic_binding_methods_supported'],
        'cryptographic_suites_supported': !exists(json, 'cryptographic_suites_supported') ? undefined : json['cryptographic_suites_supported'],
