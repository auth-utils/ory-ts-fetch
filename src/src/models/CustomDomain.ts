...
export function CustomDomainFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomDomain {
    ...
    return {
        ...
        'ssl_status': !exists(json, 'ssl_status') ? undefined : json['ssl_status'],
        'updated_at': !exists(json, 'updated_at') ? undefined : (new Date(json['updated_at'])),
        'verification_errors': !exists(json, 'verification_errors') ? undefined : json['verification_errors'],
        'verification_status': !exists(json, 'verification_status') ? undefined : json['verification_status'],
    };
}
