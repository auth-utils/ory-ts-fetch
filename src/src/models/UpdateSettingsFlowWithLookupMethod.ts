...
export function UpdateSettingsFlowWithLookupMethodFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateSettingsFlowWithLookupMethod {
    ...
    return {
        ...
        'lookup_secret_confirm': !exists(json, 'lookup_secret_confirm') ? undefined : json['lookup_secret_confirm'],
        'lookup_secret_disable': !exists(json, 'lookup_secret_disable') ? undefined : json['lookup_secret_disable'],
        'lookup_secret_regenerate': !exists(json, 'lookup_secret_regenerate') ? undefined : json['lookup_secret_regenerate'],
        'lookup_secret_reveal': !exists(json, 'lookup_secret_reveal') ? undefined : json['lookup_secret_reveal'],
        'method': json['method'],
    };
}
