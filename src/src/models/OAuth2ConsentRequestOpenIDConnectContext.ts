...
export function OAuth2ConsentRequestOpenIDConnectContextFromJSONTyped(json: any, ignoreDiscriminator: boolean): OAuth2ConsentRequestOpenIDConnectContext {
    ...
    return {
        ...
        'acr_values': !exists(json, 'acr_values') ? undefined : json['acr_values'],
        'display': !exists(json, 'display') ? undefined : json['display'],
        'id_token_hint_claims': !exists(json, 'id_token_hint_claims') ? undefined : json['id_token_hint_claims'],
        'login_hint': !exists(json, 'login_hint') ? undefined : json['login_hint'],
        'ui_locales': !exists(json, 'ui_locales') ? undefined : json['ui_locales'],
    };
}
