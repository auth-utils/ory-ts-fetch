 ...
 */
export function instanceOfProjectBrandingTheme(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "created_at" in value;
    isInstance = isInstance && "id" in value;
    isInstance = isInstance && "name" in value;
    isInstance = isInstance && "project_branding_id" in value;
...
export function ProjectBrandingThemeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectBrandingTheme {
    ...
    return {
        ...
        'accent_default_color': !exists(json, 'accent_default_color') ? undefined : json['accent_default_color'],
        'accent_disabled_color': !exists(json, 'accent_disabled_color') ? undefined : json['accent_disabled_color'],
        'accent_emphasis_color': !exists(json, 'accent_emphasis_color') ? undefined : json['accent_emphasis_color'],
        'accent_muted_color': !exists(json, 'accent_muted_color') ? undefined : json['accent_muted_color'],
        'accent_subtle_color': !exists(json, 'accent_subtle_color') ? undefined : json['accent_subtle_color'],
        'background_canvas_color': !exists(json, 'background_canvas_color') ? undefined : json['background_canvas_color'],
        'background_subtle_color': !exists(json, 'background_subtle_color') ? undefined : json['background_subtle_color'],
        'background_surface_color': !exists(json, 'background_surface_color') ? undefined : json['background_surface_color'],
        'border_default_color': !exists(json, 'border_default_color') ? undefined : json['border_default_color'],
        'created_at': (new Date(json['created_at'])),
        'error_default_color': !exists(json, 'error_default_color') ? undefined : json['error_default_color'],
        'error_emphasis_color': !exists(json, 'error_emphasis_color') ? undefined : json['error_emphasis_color'],
        'error_muted_color': !exists(json, 'error_muted_color') ? undefined : json['error_muted_color'],
        'error_subtle_color': !exists(json, 'error_subtle_color') ? undefined : json['error_subtle_color'],
        ...
        'foreground_default_color': !exists(json, 'foreground_default_color') ? undefined : json['foreground_default_color'],
        'foreground_disabled_color': !exists(json, 'foreground_disabled_color') ? undefined : json['foreground_disabled_color'],
        'foreground_muted_color': !exists(json, 'foreground_muted_color') ? undefined : json['foreground_muted_color'],
        'foreground_on_accent_color': !exists(json, 'foreground_on_accent_color') ? undefined : json['foreground_on_accent_color'],
        'foreground_on_dark_color': !exists(json, 'foreground_on_dark_color') ? undefined : json['foreground_on_dark_color'],
        'foreground_on_disabled_color': !exists(json, 'foreground_on_disabled_color') ? undefined : json['foreground_on_disabled_color'],
        'foreground_subtle_color': !exists(json, 'foreground_subtle_color') ? undefined : json['foreground_subtle_color'],
        'id': json['id'],
        'input_background_color': !exists(json, 'input_background_color') ? undefined : json['input_background_color'],
        'input_disabled_color': !exists(json, 'input_disabled_color') ? undefined : json['input_disabled_color'],
        'input_placeholder_color': !exists(json, 'input_placeholder_color') ? undefined : json['input_placeholder_color'],
        'input_text_color': !exists(json, 'input_text_color') ? undefined : json['input_text_color'],
        ...
        'success_emphasis_color': !exists(json, 'success_emphasis_color') ? undefined : json['success_emphasis_color'],
        'text_default_color': !exists(json, 'text_default_color') ? undefined : json['text_default_color'],
        'text_disabled_color': !exists(json, 'text_disabled_color') ? undefined : json['text_disabled_color'],
        'updated_at': (new Date(json['updated_at'])),
    };
}

export function ProjectBrandingThemeToJSON(value?: ProjectBrandingTheme | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
