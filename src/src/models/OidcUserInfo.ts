...
export function OidcUserInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): OidcUserInfo {
    ...
    return {
        ...
        'phone_number_verified': !exists(json, 'phone_number_verified') ? undefined : json['phone_number_verified'],
        'picture': !exists(json, 'picture') ? undefined : json['picture'],
        'preferred_username': !exists(json, 'preferred_username') ? undefined : json['preferred_username'],
