...
export function instanceOfOAuth2LoginRequest(value: object): boolean {
    ...
    isInstance = isInstance && "requested_access_token_audience" in value;
    isInstance = isInstance && "requested_scope" in value;
...
export function OAuth2LoginRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): OAuth2LoginRequest {
    ...
    return {
        ...
        'requested_access_token_audience': json['requested_access_token_audience'],
        'requested_scope': json['requested_scope'],
