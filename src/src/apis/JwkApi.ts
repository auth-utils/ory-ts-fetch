...
export class JwkApi extends runtime.BaseAPI {
    ...
    async createJsonWebKeySetRaw(requestParameters: CreateJsonWebKeySetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JsonWebKeySet>> {
        if (requestParameters.set === null || requestParameters.set === undefined) {
            throw new runtime.RequiredError('set','Required parameter requestParameters.set was null or undefined when calling createJsonWebKeySet.');
        }

        if (requestParameters.createJsonWebKeySet === null || requestParameters.createJsonWebKeySet === undefined) {
            throw new runtime.RequiredError('createJsonWebKeySet','Required parameter requestParameters.createJsonWebKeySet was null or undefined when calling createJsonWebKeySet.');
        }
    ...
    async deleteJsonWebKeyRaw(requestParameters: DeleteJsonWebKeyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.set === null || requestParameters.set === undefined) {
            throw new runtime.RequiredError('set','Required parameter requestParameters.set was null or undefined when calling deleteJsonWebKey.');
        }

        if (requestParameters.kid === null || requestParameters.kid === undefined) {
            throw new runtime.RequiredError('kid','Required parameter requestParameters.kid was null or undefined when calling deleteJsonWebKey.');
        }
    ...
    async deleteJsonWebKeySetRaw(requestParameters: DeleteJsonWebKeySetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.set === null || requestParameters.set === undefined) {
            throw new runtime.RequiredError('set','Required parameter requestParameters.set was null or undefined when calling deleteJsonWebKeySet.');
        }
    ...
    async getJsonWebKeyRaw(requestParameters: GetJsonWebKeyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JsonWebKeySet>> {
        if (requestParameters.set === null || requestParameters.set === undefined) {
            throw new runtime.RequiredError('set','Required parameter requestParameters.set was null or undefined when calling getJsonWebKey.');
        }

        if (requestParameters.kid === null || requestParameters.kid === undefined) {
            throw new runtime.RequiredError('kid','Required parameter requestParameters.kid was null or undefined when calling getJsonWebKey.');
        }
    ...
    async getJsonWebKeySetRaw(requestParameters: GetJsonWebKeySetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JsonWebKeySet>> {
        if (requestParameters.set === null || requestParameters.set === undefined) {
            throw new runtime.RequiredError('set','Required parameter requestParameters.set was null or undefined when calling getJsonWebKeySet.');
        }
    ...
    async setJsonWebKeyRaw(requestParameters: SetJsonWebKeyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JsonWebKey>> {
        if (requestParameters.set === null || requestParameters.set === undefined) {
            throw new runtime.RequiredError('set','Required parameter requestParameters.set was null or undefined when calling setJsonWebKey.');
        }

        if (requestParameters.kid === null || requestParameters.kid === undefined) {
            throw new runtime.RequiredError('kid','Required parameter requestParameters.kid was null or undefined when calling setJsonWebKey.');
        }
    ...
    async setJsonWebKeySetRaw(requestParameters: SetJsonWebKeySetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JsonWebKeySet>> {
        if (requestParameters.set === null || requestParameters.set === undefined) {
            throw new runtime.RequiredError('set','Required parameter requestParameters.set was null or undefined when calling setJsonWebKeySet.');
        }
