...
import {
    ActiveProjectInConsoleFromJSON,
    ActiveProjectInConsoleToJSON,
    ...
    GetProjectMetricsResponseFromJSON,
    GetProjectMetricsResponseToJSON,
    JsonPatchFromJSON,
    JsonPatchToJSON,
    ...
    SetActiveProjectInConsoleBodyFromJSON,
    SetActiveProjectInConsoleBodyToJSON,
    SetProjectFromJSON,
    SetProjectToJSON,
...
export interface SetActiveProjectInConsoleRequest {
...
export class ProjectApi extends runtime.BaseAPI {
    ...
    async createOrganizationRaw(requestParameters: CreateOrganizationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Organization>> {
        if (requestParameters.projectId === null || requestParameters.projectId === undefined) {
            throw new runtime.RequiredError('projectId','Required parameter requestParameters.projectId was null or undefined when calling createOrganization.');
        }
    ...
    async createProjectApiKeyRaw(requestParameters: CreateProjectApiKeyOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProjectApiKey>> {
        if (requestParameters.project === null || requestParameters.project === undefined) {
            throw new runtime.RequiredError('project','Required parameter requestParameters.project was null or undefined when calling createProjectApiKey.');
        }
    ...
    async deleteOrganizationRaw(requestParameters: DeleteOrganizationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectId === null || requestParameters.projectId === undefined) {
            throw new runtime.RequiredError('projectId','Required parameter requestParameters.projectId was null or undefined when calling deleteOrganization.');
        }
    ...
    async deleteProjectApiKeyRaw(requestParameters: DeleteProjectApiKeyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.project === null || requestParameters.project === undefined) {
            throw new runtime.RequiredError('project','Required parameter requestParameters.project was null or undefined when calling deleteProjectApiKey.');
        }

        if (requestParameters.tokenId === null || requestParameters.tokenId === undefined) {
            throw new runtime.RequiredError('tokenId','Required parameter requestParameters.tokenId was null or undefined when calling deleteProjectApiKey.');
        }
     ...
     */
    async getActiveProjectInConsoleRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ActiveProjectInConsole>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            path: `/console/active/project`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ActiveProjectInConsoleFromJSON(jsonValue));
    }
     ...
     * Returns the Ory Network Project selected in the Ory Network Console
     */
    async getActiveProjectInConsole(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ActiveProjectInConsole> {
        const response = await this.getActiveProjectInConsoleRaw(initOverrides);
        return await response.value();
    }
    ...
    async getOrganizationRaw(requestParameters: GetOrganizationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetOrganizationResponse>> {
        if (requestParameters.projectId === null || requestParameters.projectId === undefined) {
            throw new runtime.RequiredError('projectId','Required parameter requestParameters.projectId was null or undefined when calling getOrganization.');
        }
     ...
     */
    async getProjectMembersRaw(requestParameters: GetProjectMembersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<CloudAccount>>> {
        if (requestParameters.project === null || requestParameters.project === undefined) {
            throw new runtime.RequiredError('project','Required parameter requestParameters.project was null or undefined when calling getProjectMembers.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(CloudAccountFromJSON));
    }
     ...
     * Get all members associated with this project
     */
    async getProjectMembers(requestParameters: GetProjectMembersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<CloudAccount>> {
     ...
     */
    async getProjectMetricsRaw(requestParameters: GetProjectMetricsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetProjectMetricsResponse>> {
        if (requestParameters.projectId === null || requestParameters.projectId === undefined) {
        ...
        if (requestParameters.eventType === null || requestParameters.eventType === undefined) {
            throw new runtime.RequiredError('eventType','Required parameter requestParameters.eventType was null or undefined when calling getProjectMetrics.');
        }

        if (requestParameters.resolution === null || requestParameters.resolution === undefined) {
            throw new runtime.RequiredError('resolution','Required parameter requestParameters.resolution was null or undefined when calling getProjectMetrics.');
        }

        if (requestParameters.from === null || requestParameters.from === undefined) {
            throw new runtime.RequiredError('from','Required parameter requestParameters.from was null or undefined when calling getProjectMetrics.');
        }

        if (requestParameters.to === null || requestParameters.to === undefined) {
            throw new runtime.RequiredError('to','Required parameter requestParameters.to was null or undefined when calling getProjectMetrics.');
        }
        ...
        const response = await this.request({
            path: `/projects/{project_id}/metrics`.replace(`{${"project_id"}}`, encodeURIComponent(String(requestParameters.projectId))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => GetProjectMetricsResponseFromJSON(jsonValue));
    }

    /**
     * Retrieves project metrics for the specified event type and time range
     */
    async getProjectMetrics(requestParameters: GetProjectMetricsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetProjectMetricsResponse> {
    ...
    async listOrganizationsRaw(requestParameters: ListOrganizationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListOrganizationsResponse>> {
        if (requestParameters.projectId === null || requestParameters.projectId === undefined) {
            throw new runtime.RequiredError('projectId','Required parameter requestParameters.projectId was null or undefined when calling listOrganizations.');
        }
    ...
    async listProjectApiKeysRaw(requestParameters: ListProjectApiKeysRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<ProjectApiKey>>> {
        if (requestParameters.project === null || requestParameters.project === undefined) {
            throw new runtime.RequiredError('project','Required parameter requestParameters.project was null or undefined when calling listProjectApiKeys.');
        }
    ...
    async patchProjectRaw(requestParameters: PatchProjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SuccessfulProjectUpdate>> {
        if (requestParameters.projectId === null || requestParameters.projectId === undefined) {
            throw new runtime.RequiredError('projectId','Required parameter requestParameters.projectId was null or undefined when calling patchProject.');
        }
    ...
    async purgeProjectRaw(requestParameters: PurgeProjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.projectId === null || requestParameters.projectId === undefined) {
            throw new runtime.RequiredError('projectId','Required parameter requestParameters.projectId was null or undefined when calling purgeProject.');
        }
    ...
    async removeProjectMemberRaw(requestParameters: RemoveProjectMemberRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.project === null || requestParameters.project === undefined) {
            throw new runtime.RequiredError('project','Required parameter requestParameters.project was null or undefined when calling removeProjectMember.');
        }

        if (requestParameters.member === null || requestParameters.member === undefined) {
            throw new runtime.RequiredError('member','Required parameter requestParameters.member was null or undefined when calling removeProjectMember.');
        }
     ...
     */
    async setActiveProjectInConsoleRaw(requestParameters: SetActiveProjectInConsoleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: SetActiveProjectInConsoleBodyToJSON(requestParameters.setActiveProjectInConsoleBody),
        }, initOverrides);
     ...
     * Sets the Ory Network Project active in the Ory Network Console
     */
    async setActiveProjectInConsole(requestParameters: SetActiveProjectInConsoleRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.setActiveProjectInConsoleRaw(requestParameters, initOverrides);
    }
    ...
    async setProjectRaw(requestParameters: SetProjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SuccessfulProjectUpdate>> {
        if (requestParameters.projectId === null || requestParameters.projectId === undefined) {
            throw new runtime.RequiredError('projectId','Required parameter requestParameters.projectId was null or undefined when calling setProject.');
        }
    ...
    async updateOrganizationRaw(requestParameters: UpdateOrganizationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Organization>> {
        if (requestParameters.projectId === null || requestParameters.projectId === undefined) {
            throw new runtime.RequiredError('projectId','Required parameter requestParameters.projectId was null or undefined when calling updateOrganization.');
        }
