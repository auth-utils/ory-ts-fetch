...
export class PermissionApi extends runtime.BaseAPI {
    ...
    async checkPermissionRaw(requestParameters: CheckPermissionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CheckPermissionResult>> {
        ...
        if (requestParameters.subjectSetNamespace !== undefined) {
            queryParameters['subject_set.namespace'] = requestParameters.subjectSetNamespace;
        }

        if (requestParameters.subjectSetObject !== undefined) {
            queryParameters['subject_set.object'] = requestParameters.subjectSetObject;
        }

        if (requestParameters.subjectSetRelation !== undefined) {
    ...
    async expandPermissionsRaw(requestParameters: ExpandPermissionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ExpandedPermissionTree>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
            throw new runtime.RequiredError('namespace','Required parameter requestParameters.namespace was null or undefined when calling expandPermissions.');
        }

        if (requestParameters.object === null || requestParameters.object === undefined) {
            throw new runtime.RequiredError('object','Required parameter requestParameters.object was null or undefined when calling expandPermissions.');
        }

        if (requestParameters.relation === null || requestParameters.relation === undefined) {
            throw new runtime.RequiredError('relation','Required parameter requestParameters.relation was null or undefined when calling expandPermissions.');
        }
